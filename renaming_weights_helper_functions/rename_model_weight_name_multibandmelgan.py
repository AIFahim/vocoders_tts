...
checkpoint = torch.load("/home/asif/tts_all/coqui_tts/my_exp/coqui_vocoder/multibandmelgan_weights/48_sr_model_weight/best_model_296927.pth")
...
for key, value in state_dict.items():
    if not key.startswith('model_d.discriminators'):
...
torch.save(checkpoint, '/home/asif/tts_all/coqui_tts/my_exp/coqui_vocoder/multibandmelgan_weights/renamed_weights_44k_296927.pth')

checkpoint_new = torch.load("/home/asif/tts_all/coqui_tts/my_exp/coqui_vocoder/multibandmelgan_weights/renamed_weights_44k_296927.pth")
